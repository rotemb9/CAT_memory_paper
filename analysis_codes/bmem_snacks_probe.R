...
# define sessions (options: 1 or 2 or 3 or combinations e.g. 2:3 or 1:3)
sessions = 1:3
...
probe_results$Session=c('Session 1', 'Session 1', 'Session 2', 'Session 2', 'Follow-up Session', 'Follow-up Session')
...
CI_min=exp(Results_df_go_nogo$Estimate-1.96*Results_df_go_nogo$`Std. Error`)
CI_max=exp(Results_df_go_nogo$Estimate+1.96*Results_df_go_nogo$`Std. Error`)
