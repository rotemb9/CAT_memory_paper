function familiarity(subjectID, sessionNum, type, use_eyetracker, debugging_mode)
%=========================================================================
% familiarity task
%=========================================================================
% created by Rani, edited by Roni and then Rotem on June 2017
% function familiarity(subjectID, sessionNum, type, use_eyetracker)
% creates the output file: [subjectID '_familiarity' num2str(sessionNum) '_' timestamp '.txt']

% types: familiarity/demo/other
...
ScaleText{2} = ' not at all';
ScaleText{4} = '      slightly';
ScaleText{7} = 'moderately';
ScaleText{end-1} = '  extremely';
...
switch type
    case 'familiarity'
    Task=GenFlags.Familiarity.str;
    output_filename = [OutputFolder subjectID '_' type num2str(sessionNum) '_' timestamp '.txt'];
    case 'demo'
    Task=GenFlags.FamiliarityDemo.str;
    output_filename = [OutputFolder subjectID '_familiarity_demo_' timestamp '.txt'];
    otherwise
    output_filename = [OutputFolder subjectID '_familiarity_' StimuliName '_' timestamp '.txt'];
end

fid1 = fopen(output_filename, 'a');
fprintf(fid1,'subjectID\truntrial\tonsettime\tName\tRank\tRT\tfirst_mouse_movement\n'); %write the header line
...
switch type
    case 'familiarity'
        Instructions=dir([mainPath '/Instructions/familiarity.JPG' ]);
    case 'demo'
        Instructions=dir([mainPath '/Instructions/familiarity_Demo.JPG' ]);
    otherwise
        Instructions=dir([mainPath '/Instructions/familiarity_' type '.JPG' ]);    
end
