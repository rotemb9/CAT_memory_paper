function recognition_confidence_new(subjectID,isMRI,mainPath,order, sessionNum,use_eyetracker)

% function recognition_confidence_new(subjectID,test_comp,mainPath,order, sessionNum,use_eyetracker)
% = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
% =============== Created based on the previous boost codes ===============
% ==================== by Rotem Botvinik November 2015 ====================
% Edited by Rotem Botvinik nezer on August 2016 to add  time limitation of
% 3 seconds for each trial
...
Instructions = dir([mainPath '/Instructions/recognition_confidence_new.JPG' ]);
Instructions_fmri = dir([mainPath '/Instructions/recognition_confidence_new.JPG' ]);
...
if use_eyetracker
    ...
    if dummymode==0
        movefile(edfFile,['./Output/', subjectID,'_recognition_eyetracking_' timestamp,'.edf']);
    end
